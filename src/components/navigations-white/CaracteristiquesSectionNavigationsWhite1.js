...
export default function CaracteristiquesSectionNavigationsWhite1() {
  ...
  <nav className="flex justify-between p-6 px-4">
    <div className="flex justify-between items-center w-full">
      ...
      <div className="hidden xl:block xl:w-1/3">
        ...
        <li className="mr-12"><a className="text-coolGray-500 hover:text-coolGray-900 font-medium" href="/">Produit</a></li>
      ...
      <div className="hidden xl:block xl:w-1/3">
        <div className="flex items-center justify-end"><a className="inline-block py-2 px-4 mr-2 leading-5 text-coolGray-500 hover:text-coolGray-900 bg-transparent font-medium rounded-md" href="#">Log In</a><a className="inline-block py-2 px-4 text-sm leading-5 text-yellow-50 bg-yellow-500 hover:bg-yellow-600 font-medium focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50 rounded-md" href="#">Sign Up</a></div>
      </div>
    </div>
