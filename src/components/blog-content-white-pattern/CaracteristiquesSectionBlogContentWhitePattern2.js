...
export default function CaracteristiquesSectionBlogContentWhitePattern2() {
    return (
        <React.Fragment>
            <>
                <section className="py-16 md:py-24 bg-white" style={{backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center top'}}>
  <div className="container px-4 mx-auto">
    <div className="md:max-w-2xl mx-auto mb-12 text-center">
      <div className="flex items-center justify-center">
        <p className="inline-block text-yellow-500 font-medium">John Doe</p>
        <span className="mx-1 text-yellow-500">•</span>
        <p className="inline-block text-yellow-500 font-medium">19 Jan 2022</p>
      </div>
      <h2 className="mb-4 text-3xl md:text-5xl leading-tight text-darkCoolGray-900 font-bold tracking-tighter">Lorem ipsum dolor sit amet</h2>
      <p className="mb-6 text-lg md:text-xl font-medium text-coolGray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
      <div className="inline-block py-1 px-3 text-xs leading-5 text-yellow-500 font-medium uppercase bg-yellow-100 rounded-full shadow-sm">Technology</div>
    </div>
    <div className="mb-10 mx-auto max-w-max overflow-hidden rounded-lg">
      <img src="flex-ui-assets/images/blog-content/content-photo1.jpg" alt="" />
    </div>
    <div className="md:max-w-3xl mx-auto">
      <p className="mb-8 pb-10 text-lg md:text-xl font-medium text-coolGray-500 border-b border-coolGray-100">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus. Non massa enim vitae duis mattis. Vel in ultricies vel fringilla.</p>
      ...
      <div className="mb-6 p-6 border-l-2 border-yellow-500">
        <p className="mb-4 text-xl md:text-2xl leading-tight font-medium text-coolGray-800">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus.</p>
        <span className="text-base md:text-lg text-coolGray-400 font-medium">— John Doe, CEO &amp; Founder</span>
      </div>
      <p className="mb-6 text-base md:text-lg text-coolGray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus. Non massa enim vitae duis mattis. Vel in ultricies vel fringilla.</p>
      ...
      <h3 className="mb-4 text-2xl md:text-3xl font-semibold text-coolGray-800">Header 1</h3>
      <p className="mb-14 text-base md:text-lg text-coolGray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus. Non massa enim vitae duis mattis. Vel in ultricies vel fringilla.</p>
      ...
      <p className="mb-10 pb-10 text-base md:text-lg text-coolGray-500 border-b border-coolGray-100">
        ...
        <a className="text-yellow-500 hover:text-yellow-600 underline" href="#">Vivamus id pharetra massa</a>
